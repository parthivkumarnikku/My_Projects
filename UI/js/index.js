...
function updateStepsPerformance() {
  ...
  function updateChartPage() {
      ...
      window.open(`graph.html?monday=${mondayCalories}&tuesday=${tuesdayCalories}&wednesday=${wednesdayCalories}&thursday=${thursdayCalories}&friday=${fridayCalories}&saturday=${saturdayCalories}&sunday=${sundayCalories}`, '_blank');
  }
